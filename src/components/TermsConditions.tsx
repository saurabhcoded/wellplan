        ...
        <div className="bg-slate-800 rounded-2xl p-8 border border-slate-700">
          ...
          <div className="space-y-8 text-slate-300">
            <section>
              ...
              <p className="mb-4">
                By accessing and using WellPlan, you accept and agree to be
            ...
            <section>
              ...
              <p className="mb-4">
                WellPlan provides a fitness tracking and workout planning
            ...
            <section>
              ...
              <div className="bg-yellow-500/10 border border-yellow-500/50 rounded-lg p-4 mb-4">
                ...
                <p className="text-yellow-100">
                  WellPlan is not a medical service and does not provide medical
                  advice. Always consult with a qualified healthcare
                  professional before starting any fitness program. We are not
                  responsible for any injuries or health issues that may result
            ...
            <section>
              ...
              <p className="mb-4">
                All content, features, and functionality of WellPlan are owned
                by us and are protected by copyright, trademark, and other
                intellectual property laws. You may not copy, modify,
                distribute, or reproduce any content without our express written
                permission.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mb-4">
                To the maximum extent permitted by law, WellPlan shall not be
            ...
            <section>
              ...
              <p className="mb-4">
                ...
                including breach of these Terms. You may also terminate your
                account at any time by contacting us or using the account
                deletion feature.
              </p>
            </section>
